    ...
    return (
        <nav className='navbar' aria-label='Main navigation'>
            <ul>
                ...
                <li><a href="/tristan-portfolio-site/images/TristanCravelloSWEResume2026.pdf" target='_blank' rel='noopener noreferrer' aria-label='View Resume PDF' className='resume-link'>Resume</a></li>
            </ul>
        </nav>
    );
};
